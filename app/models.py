...
class User(Base):
    ...
    active_session_id = Column(String(128), nullable=True, index=True)
    active_session_expires_at = Column(DateTime, nullable=True)
...
class Attendance(Base):
    ...
    floor_no = Column(String(50), nullable=True)
