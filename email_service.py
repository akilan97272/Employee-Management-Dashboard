...
def send_leave_requested_email(to_email: str, name: str, start_date: str, end_date: str, reason: str) -> bool:
...
def send_leave_status_email(to_email: str, name: str, start_date: str, end_date: str, reason: str, status: str) -> bool:
...
def send_meeting_invite(to_email: str, name: str, title: str, when: str, organizer: str, link: Optional[str]) -> bool:
